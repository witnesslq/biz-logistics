...
public class TransportController extends AbstractController<Transport, Long> implements ITransportController {
    ...
    private final static String PATH_END = "/transports";
    ...
    public ResponseEntity<Response> getByConditions(@RequestBody(required = false) Transport record, @RequestParam int page, @RequestParam int size) throws Exception {
