...
public class RoleController extends AbstractController<Role, Long> implements IRoleController {
    ...
    private final static String PATH_END = "/roles";
    ...
    public ResponseEntity<Response> getByConditions(@RequestBody(required = false) Role record, @RequestParam int page, @RequestParam int size) throws Exception {
