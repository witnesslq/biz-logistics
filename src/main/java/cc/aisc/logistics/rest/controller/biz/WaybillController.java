...
public class WaybillController extends AbstractController<Waybill, Long> implements IWaybillController {
    ...
    private final static String PATH_END = "/waybills";
    ...
    public ResponseEntity<Response> getByConditions(@RequestBody(required = false) Waybill record, @RequestParam int page, @RequestParam int size) throws Exception {
