...
public class TruckController extends AbstractController<Truck, Long> implements ITruckController {
    ...
    private final static String PATH_END = "/trucks";
    ...
    public ResponseEntity<Response> getByConditions(@RequestBody(required = false) Truck record, @RequestParam int page, @RequestParam int size) throws Exception {
